...
acf_add_local_field_group(array (
  ...
  'fields' => array (
    ...
    array (
      'key' => 'field_56d0d9442d23f',
      'label' => 'Phone Number',
      'name' => 'phone_number',
      'type' => 'text',
      'instructions' => 'Enter the agency\'s phone number. This should be entered however you\'d like it to display.',
      'required' => 1,
      'conditional_logic' => 0,
      'wrapper' => array (
        'width' => '',
    ...
    array (
      'key' => 'field_56d0d97b2d240',
      'label' => 'Email Address',
      'name' => 'email_address',
      'type' => 'text',
      'instructions' => 'Enter the agency\'s email address.',
      'required' => 1,
      'conditional_logic' => 0,
      'wrapper' => array (
        'width' => '',
